        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="obj-1 d-flex">
              <img className="mx-2 img-fluid" src={objectsImage1} alt />
              <img className="img-fluid" src={objectsImage2} alt />
            </div>
          </div>
        </div>
      </div>
      <div className="col-md-5 sgniu">
